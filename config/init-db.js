...
const defaultSettings = [
  ...
  // v46: What We Do (WWD) section - all editable
  ['wwd_eyebrow_th', 'ธุรกิจของเรา', 'text', 'homepage', 'WWD Eyebrow (Thai)', 'Small label above the WWD title'],
  ['wwd_eyebrow_en', 'OUR BUSINESSES', 'text', 'homepage', 'WWD Eyebrow (English)', ''],
  ['wwd_title_th', 'สิ่งที่เราทำ', 'text', 'homepage', 'WWD Title (Thai)', 'Main heading of the What We Do section'],
  ['wwd_title_en', 'What we do', 'text', 'homepage', 'WWD Title (English)', ''],
  ['wwd_cta_th', 'ดูธุรกิจทั้งหมด', 'text', 'homepage', 'WWD CTA Link Text (Thai)', 'Text on the "explore all businesses" link'],
  ['wwd_cta_en', 'Explore all businesses', 'text', 'homepage', 'WWD CTA Link Text (English)', ''],
  ['wwd_stat1_label_th', 'หน่วยธุรกิจ', 'text', 'homepage', 'WWD Stat 1 Label (Thai)', 'Auto-counted from businesses count'],
  ['wwd_stat1_label_en', 'Business Units', 'text', 'homepage', 'WWD Stat 1 Label (English)', ''],
  ['wwd_stat2_value', '50+', 'text', 'homepage', 'WWD Stat 2 Value', 'e.g. "50+", "100+"'],
  ['wwd_stat2_label_th', 'ปีประสบการณ์', 'text', 'homepage', 'WWD Stat 2 Label (Thai)', ''],
  ['wwd_stat2_label_en', 'Years Experience', 'text', 'homepage', 'WWD Stat 2 Label (English)', ''],
  ...
  // v46: Default fallback banner used by all pages without their own banner
  ['default_page_banner', '', 'image', 'general', 'Default Page Banner (Fallback)', 'Used as the banner image for any page (About, Businesses, News, etc.) that does not have its own banner assigned. Recommended: 1920x500px JPG.'],
...
async function initialize() {
  ...
  const migrations = [
    ...
    // ===== v37: Menu label translations =====
    "ALTER TABLE menus ADD COLUMN label_en VARCHAR(190) NULL",
    "ALTER TABLE menus ADD COLUMN label_zh VARCHAR(190) NULL",
    "ALTER TABLE menus ADD COLUMN label_ja VARCHAR(190) NULL",
  ];
